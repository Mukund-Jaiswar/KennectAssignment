//Function for number to find out if it is a prime number or not
...
function isPrimeAndNextDiff(num){
    ...
    if(isPrimeNum(num)){
        ...
        return console.log(`${num} is a Prime Number and the diff with next prime number is: ${diff}`)
    }else{
        return console.log(`${num} is not a Prime Number`)
    }
}

isPrimeAndNextDiff(23)
//Output
//23 is a Prime Number and the diff with next prime number is: 6